...
ALTER TABLE profile_attribute_configs
    ADD COLUMN self_registration_edit BOOLEAN NOT NULL DEFAULT FALSE;

-- Separate layout properties for the self-service profile-edit form.
ALTER TABLE profile_attribute_configs
    ADD COLUMN self_service_section_name  VARCHAR(100),
    ADD COLUMN self_service_column_span   INT NOT NULL DEFAULT 3,
    ADD COLUMN self_service_display_order INT NOT NULL DEFAULT 0;
