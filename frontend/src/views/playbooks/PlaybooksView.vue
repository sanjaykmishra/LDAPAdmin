...
<template>
  <div class="p-6">
    ...
    <AppModal v-model="showPreviewModal" title="Run Playbook" size="md">
      ...
      <template #footer>
        <button @click="showPreviewModal = false" class="btn-secondary">Cancel</button>
...
.btn-secondary { @apply px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50; }
