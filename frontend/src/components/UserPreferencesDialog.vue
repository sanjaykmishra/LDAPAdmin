  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40" @click.self="$emit('close')">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[85vh] flex flex-col">
      <div class="flex items-center justify-between px-5 py-3 border-b border-gray-200">
        <h3 class="text-base font-semibold text-gray-900">User Preferences</h3>
      ...
      <div class="px-5 py-3 border-t border-gray-200 flex justify-between items-center">
        ...
        <div class="flex gap-2 ml-auto">
          <button @click="$emit('close')" class="btn-neutral text-sm">Cancel</button>
...
.input { @apply border border-gray-300 rounded-lg px-3 py-2 text-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500; }
</style>
